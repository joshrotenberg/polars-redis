    ...
    "Rust Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "837bd853f4c9de847d49adf4e67eb2046e5c042f",
          "message": "refactor: reorganize code into io/ and client/ modules (#180)\n\n- Create src/io/ for DataFrame I/O operations (cache, infer, scanner, search, types, write)\n- Create src/client/ for general Redis client operations (geo, keys, pipeline, pubsub)\n- Update all internal import paths to use new module structure\n- Update doc comments, tests, examples, and benchmarks to use new paths\n\nCloses #177",
          "timestamp": "2026-01-07T15:13:29-08:00",
          "tree_id": "ce439d9fc14cf483aa8edcdf966c12711c1367ef",
          "url": "https://github.com/joshrotenberg/polars-redis/commit/837bd853f4c9de847d49adf4e67eb2046e5c042f"
        },
        "date": 1767828198936,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e2f133408b7b5cdef25e8ad8f78486720e6ec1d3",
          "message": "chore(main): release polars-redis 0.1.7 (#142)\n\nCo-authored-by: github-actions[bot] <41898282+github-actions[bot]@users.noreply.github.com>",
          "timestamp": "2026-01-09T15:10:05-08:00",
          "tree_id": "27ada69a5f477ba174816519b03727ea1cd474db",
          "url": "https://github.com/joshrotenberg/polars-redis/commit/e2f133408b7b5cdef25e8ad8f78486720e6ec1d3"
        },
        "date": 1768000841806,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "acc4b40916fce02d1e18e1e0fd915fa3f1e27137",
          "message": "chore(main): release polars-redis 0.1.8 (#201)\n\nCo-authored-by: github-actions[bot] <41898282+github-actions[bot]@users.noreply.github.com>",
          "timestamp": "2026-02-11T11:15:57+01:00",
          "tree_id": "f0a6bff366a6c800353c6fcb6613727a034f4c7a",
          "url": "https://github.com/joshrotenberg/polars-redis/commit/acc4b40916fce02d1e18e1e0fd915fa3f1e27137"
        },
        "date": 1770805630237,
        "tool": "cargo",
        "benches": [
