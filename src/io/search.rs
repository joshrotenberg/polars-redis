...
//!
//! ```ignore
//! use polars_redis::io::search::{SearchConfig, search_hashes};
//!
...
use crate::io::types::hash::HashData;
...
///
/// ```ignore
/// use polars_redis::io::search::{SearchConfig, HighlightOptions};
///
...
///
/// ```ignore
/// use polars_redis::io::search::{AggregateConfig, ReduceOp, SortBy};
///
...
///
/// ```ignore
/// use polars_redis::io::search::{AggregateConfig, ReduceOp, aggregate};
///
/// let config = AggregateConfig::new("users_idx", "*")
///     .with_group_by(vec!["city"])
///     .with_reduce(vec![
